...
class OpenViduCallView extends Component {
    constructor(props) {
        super(props);
        ...
        return (
            <div >
                    ...
                    <div id="session">
                        <OpenViduSession
                            id="opv-session"
                            openviduServerUrl={this.OPENVIDU_SERVER_URL}
                            openviduSecret={this.OPENVIDU_SERVER_SECRET}
...
export default OpenViduCallView;
